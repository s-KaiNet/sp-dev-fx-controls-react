var LocalesHelper = /** @class */ (function () {
    function LocalesHelper() {
    }
    LocalesHelper.getLocaleId = function (localeName) {
        var _this = this;
        var pos = Object.keys(this.locales).findIndex(function (locKey) { return _this.locales[parseInt(locKey)] === localeName; });
        if (pos > -1) {
