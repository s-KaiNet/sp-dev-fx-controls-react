...
var Term = /** @class */ (function (_super) {
    ...
    function Term(props) {
        ...
        _this.onCollapseClick = function (ev) {
            ev.preventDefault();
            ev.stopPropagation();
            _this.setState({
            ...
            if (_this.props.onToggleClick) {
                _this.props.onToggleClick(_this.props.term);
            }
        };
        ...
        _this.state = {
            ...
            hidden: false,
            disabled: false,
            collapsed: _this.props.term.PathDepth > 1,
            toggleHidden: _this.props.term.PathDepth > 2
        };
    ...
    Term.prototype.UNSAFE_componentWillReceiveProps = function (nextProps, nextContext) {
        ...
        if (this.props.toggledTerm !== nextProps.toggledTerm) {
            if (this.hasParentWithId((_a = nextProps.toggledTerm) === null || _a === void 0 ? void 0 : _a.Id)) {
                this.setState({
    ...
    Term.prototype.hasParentWithId = function (id) {
        var _a;
        var term = this.props.termsMap.get(this.props.term.Id);
        if (!term || !term.parent)
            return false;
        ...
        while (parent) {
            ...
            parent = (_a = this.props.termsMap.get(parent.term.Id)) === null || _a === void 0 ? void 0 : _a.parent;
        }
        return false;
    };
    /**
    ...
    Term.prototype.render = function () {
        var styleProps = {
            marginLeft: "".concat(((this.props.term.PathDepth - 1) * 35), "px")
        };
        var checkBoxStyle = {
            display: "inline-flex"
        };
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "".concat(styles.listItem, " ").concat(styles.term), style: styleProps },
                this.props.term.PathDepth < this.props.maxLevel && React.createElement("img", { onClick: this.onCollapseClick, src: this.state.collapsed ? COLLAPSED_IMG : EXPANDED_IMG, alt: strings.TaxonomyPickerExpandTitle, title: strings.TaxonomyPickerExpandTitle }),
