...
export var TermTree = function (_a) {
    ...
    var _b = useState(true), shouldRenderImg = _b[0], setShouldRenderImg = _b[1];
    var _c = useState(term.PathDepth < 2), expanded = _c[0], setExpanded = _c[1];
    var onCollapseClick = function () {
        setExpanded(!expanded);
    };
    useEffect(function () {
        var shouldRenderImg = function () { return __awaiter(void 0, void 0, void 0, function () {
            var _i, children_1, child, childIsHidden, _a, _b, action, shouldApply, result;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!((_c = props.termActions.actions) === null || _c === void 0 ? void 0 : _c.length) || !children.length) {
        ...
        shouldRenderImg().then(function (result) {
            setShouldRenderImg(result);
        });
    }, []);
    return (React.createElement("div", { className: styles.termTree },
        term.PathDepth < props.maxLevel && shouldRenderImg && React.createElement("img", { onClick: onCollapseClick, src: expanded ? EXPANDED_IMG : COLLAPSED_IMG, alt: strings.TaxonomyPickerExpandTitle, title: strings.TaxonomyPickerExpandTitle }),
