...
var TermParent = /** @class */ (function (_super) {
    ...
    function TermParent(props) {
        ...
        _this.onToggleClick = function (term, collapse) {
            _this.setState({
                collapseClickedTerm: { term: term, collapsed: collapse }
            });
        };
    ...
    TermParent.prototype.render = function () {
        ...
        if (this.state.loaded) {
            ...
            if (this._terms.length > 0) {
                termElm = (React.createElement("div", { style: styleProps }, this._termTree.map(function (termsTree) {
