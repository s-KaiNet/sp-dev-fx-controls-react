...
var TermParent = /** @class */ (function (_super) {
    ...
    function TermParent(props) {
        ...
        _this.onToggleClick = function (term) {
            _this.setState({
                collapseClickedTerm: __assign({}, term)
            });
        };
   ...
   */
    ...
    TermParent.prototype.render = function () {
        ...
        if (this.state.loaded) {
            var maxLevel_1 = this._terms.reduce(function (maxDepth, currentTerm) {
