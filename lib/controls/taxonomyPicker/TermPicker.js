...
var TermPicker = /** @class */ (function (_super) {
    ...
    TermPicker.prototype.onFilterChanged = function (filterText, tagList) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, termPickerHostProps, isTermSetSelectable, termResults, terms, termSet, filteredTerms, _c, disabledTermIds_1, disableChildrenOfDisabledParents, _loop_1, this_1, _i, terms_1, term;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!(filterText !== "")) return [3 /*break*/, 8];
                        _b = this.props, termPickerHostProps = _b.termPickerHostProps, isTermSetSelectable = _b.isTermSetSelectable;
                    ...
                    case 3:
                        filteredTerms = [];
                        _c = this.props, disabledTermIds_1 = _c.disabledTermIds, disableChildrenOfDisabledParents = _c.disableChildrenOfDisabledParents;
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        if (!(((_a = this_1.props.termPickerHostProps.termActions.actions) === null || _a === void 0 ? void 0 : _a.length) > 0)) return [3 /*break*/, 5];
