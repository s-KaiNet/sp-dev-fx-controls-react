...
var DynamicFormBase = /** @class */ (function (_super) {
    ...
    function DynamicFormBase(props) {
            ...
            return __generator(this, function (_m) {
                switch (_m.label) {
                    ...
                    case 27:
                        ...
                        objects[contentTypeIdField] = contentTypeId; // eslint-disable-line @typescript-eslint/no-explicit-any
         ...
         */
        _this.updateListItemRetry = function (list_1, itemId_1, objects_1) {
            var args_1 = [];
            for (var _i = 3; _i < arguments.length; _i++) {
                args_1[_i - 3] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([list_1, itemId_1, objects_1], args_1, true), void 0, function (list, itemId, objects, retry) {
                var error_8;
