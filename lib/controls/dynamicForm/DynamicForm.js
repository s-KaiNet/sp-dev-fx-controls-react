                ...
                switch (_a.label) {
                    case 0:
                        ...
                        _loop_3 = function (i, len) {
                            var field, hiddenName, termSetId, anchorId, lookupListId, lookupField, choices_1, defaultValue, value, stringValue, subPropertyValues, richText, dateFormat, principalType, cultureName, minValue, maxValue, showAsPercentage, selectedTags_1, choiceType, fieldName, numberField, userEmails, _b, _c, response, term, _selectedTags, response;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
