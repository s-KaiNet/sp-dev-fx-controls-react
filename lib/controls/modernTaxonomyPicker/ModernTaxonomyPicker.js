...
export function ModernTaxonomyPicker(props) {
    ...
    function onRenderSuggestionsItem(term, itemProps) {
        return (React.createElement(TermItemSuggestion, __assign({ onLoadParentLabel: onLoadParentLabel, term: term, termStoreInfo: currentTermStoreInfo, languageTag: currentLanguageTag, searchFilter: searchFilter }, itemProps)));
    }
    ...
    function onRenderItem(itemProps) {
        ...
        return labels.length > 0 ? (React.createElement(TermItem, __assign({ languageTag: currentLanguageTag, termStoreInfo: currentTermStoreInfo, name: fullParentPrefixes.join(":") }, termItemProps), fullParentPrefixes.join(":"))) : null;
    }
