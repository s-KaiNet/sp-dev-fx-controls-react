...
var NameValuePairPropertyEditor = /** @class */ (function (_super) {
    ...
    NameValuePairPropertyEditor.prototype.collectionChanged = function (context, nameValuePairs, refreshPropertySheet) {
        context.target[this.collectionPropertyName] = []; // eslint-disable-line @typescript-eslint/no-explicit-any
        for (var _i = 0, nameValuePairs_1 = nameValuePairs; _i < nameValuePairs_1.length; _i++) {
            ...
            context.target[this.collectionPropertyName].push(item); // eslint-disable-line @typescript-eslint/no-explicit-any
        }
    ...
    NameValuePairPropertyEditor.prototype.render = function (context) {
        ...
        var collection = context.target[this.collectionPropertyName]; // eslint-disable-line @typescript-eslint/no-explicit-any
