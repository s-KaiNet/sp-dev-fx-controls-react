...
var RichText = /** @class */ (function (_super) {
    ...
    RichText.prototype.render = function () {
        ...
        var _c = this.props, placeholder = _c.placeholder, _d = _c.styleOptions, showStyles = _d.showStyles, showBold = _d.showBold, showItalic = _d.showItalic, showUnderline = _d.showUnderline, showAlign = _d.showAlign, showList = _d.showList, showLink = _d.showLink, showMore = _d.showMore, showImage = _d.showImage;
        ...
        return (React.createElement("div", { ref: function (ref) { _this._wrapperRef = ref; }, className: css(styles.richtext && this.state.editing ? 'ql-active' : null, this.props.className || null) || null },
            renderLabel,
