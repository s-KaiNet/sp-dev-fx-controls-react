            ...
            React.createElement("div", { className: styles.labels, onClick: function (e) {
                ...
                item.iconProps &&
                    React.createElement("span", null,
                        React.createElement(Icon, { className: styles.icon, iconName: item.iconProps.iconName, style: item.iconProps.style, theme: this.props.theme, imageProps: item.iconProps.imageProps }),
                        "\u00A0"),
                item.label,
                // Render sublabel
                item.subLabel &&
