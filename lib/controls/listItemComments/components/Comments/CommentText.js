            ...
            if (hasMentions) {
                lineContent = regexifyString({
                    ...
                    decorator: function (match, index) {
                        ...
                        return (React.createElement(LivePersona, { serviceScope: serviceScope, upn: mention.email, template: React.createElement("span", { style: { color: theme.themePrimary, whiteSpace: 'nowrap' } }, _name) }));
                    },
                    input: line,
                });
            }
            result.push(React.createElement(Stack, { horizontal: true, key: "stack-".concat(idx), horizontalAlign: "start", verticalAlign: "center" }, isArray(lineContent) ? (lineContent.length > 0 ?
                ...
                }) : React.createElement("br", null)) : lineContent.trim().length > 0 ? (React.createElement(Text, { variant: "small" }, convertTextToLinksAndText(he.decode(lineContent)))) : (React.createElement("br", null))));
        });
        setCommentText(result);
    }, []);
    return (React.createElement(React.Fragment, null,
        React.createElement(Stack, { wrap: true, verticalAlign: "center" }, commentText)));
};
