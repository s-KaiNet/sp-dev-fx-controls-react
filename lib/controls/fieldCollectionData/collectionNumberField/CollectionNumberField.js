...
var CollectionNumberField = /** @class */ (function (_super) {
     ...
     */
    CollectionNumberField.prototype.UNSAFE_componentWillMount = function () {
        this.setState({
     ...
     * @param nextState
     */
    CollectionNumberField.prototype.UNSAFE_componentWillUpdate = function (nextProps, nextState) {
    ...
    CollectionNumberField.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "FieldCollectionData__panel__number-field ".concat(styles.numberField, " ").concat(this.state.errorMessage ? styles.invalidField : "") },
