...
var GroupPicker = React.lazy(function () { return import('../../../GroupPicker').then(function (module) { return ({ default: module.GroupPicker }); }); });
...
var ListToolbar = React.lazy(function () { return import('../../../controls/ListToolbar').then(function (module) { return ({ default: module.ListToolbar }); }); });
        ...
        return (React.createElement(React.Suspense, { fallback: React.createElement("div", null, "Loading...") },
            React.createElement("div", { className: styles.controlsTest },
                ...
                controlVisibility.GroupPicker &&
                    React.createElement("div", { id: "GroupPickerDiv", className: styles.container },
                        React.createElement(GroupPicker, { appcontext: this.props.context, label: "Group Picker", itemLimit: 3, selectedGroups: this.state.selectedGroups, multiSelect: true, onSelectedGroups: function (tagList) {
                                _this.setState({ selectedGroups: tagList });
                            }, groupType: "M365", themeVariant: this.props.themeVariant })),
                ...
                controlVisibility.ListToolbar &&
                    React.createElement("div", { id: "ListToolbarDiv", className: styles.container },
                        React.createElement("h3", null, "ListToolbar"),
                        React.createElement(ListToolbar, { context: this.props.context, theme: this.props.themeVariant, items: [
                                { key: 'new', label: 'New', icon: React.createElement("span", null, "+"), onClick: function () { return console.log('New clicked'); }, group: 'actions' },
                                { key: 'edit', label: 'Edit', icon: React.createElement("span", null, "\u270E"), onClick: function () { return console.log('Edit clicked'); }, group: 'actions' },
                                { key: 'delete', label: 'Delete', icon: React.createElement("span", null, "\uD83D\uDDD1"), onClick: function () { return console.log('Delete clicked'); }, appearance: 'subtle', group: 'danger' },
                            ], farItems: [
                                { key: 'filter', label: 'Filter', icon: React.createElement("span", null, "\uD83D\uDD0D"), onClick: function () { return console.log('Filter clicked'); }, isFarItem: true },
                                { key: 'settings', label: 'Settings', icon: React.createElement("span", null, "\u2699"), onClick: function () { return console.log('Settings clicked'); }, isFarItem: true },
                            ], totalCount: 10, showGroupDividers: true, ariaLabel: "List Toolbar" })),
