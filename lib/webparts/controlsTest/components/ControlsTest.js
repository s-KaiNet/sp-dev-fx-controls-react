       ...
       */
        ...
        return (React.createElement("div", { className: styles.controlsTest },
            ...
            React.createElement("div", { id: "TaxonomyPickerDiv", className: styles.container, hidden: !controlVisibility.TaxonomyPicker },
                React.createElement("div", { className: "ms-font-m" },
                    "Services tester:",
                    React.createElement(TaxonomyPicker, { simpleSelectionInSingleMode: false, allowMultipleSelections: true, termsetNameOrID: "Country_TEST", panelTitle: "Select Sorted Term", label: "Service Picker with custom actions", context: this.props.context, 
