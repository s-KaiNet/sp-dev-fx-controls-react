        ...
        _this.downloadSPFileContent = function (absoluteFileUrl, fileName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        err_1 = _a.sent();
                        console.error("[OneDriveService.fetchFileContent] Err='".concat(err_1 instanceof Error ? err_1.message : String(err_1), "'"));
        ...
        _this.getOneDriveRootFolderFullUrl = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_2 = _a.sent();
                        console.error("[FileBrowserService.getOneDrivePersonalUrl] Err='".concat(error_2 instanceof Error ? error_2.message : String(error_2), "'"));
        ...
        _this.getOneDrivePersonalUrl = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        console.error("[FileBrowserService.getOneDrivePersonalUrl] Err='".concat(error_3 instanceof Error ? error_3.message : String(error_3), "'"));
