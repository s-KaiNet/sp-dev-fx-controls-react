        ...
        this.checkFileExists = function (fileUrl) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.error("[BingFilesService.fetchFile]: Err='".concat(err_1 instanceof Error ? err_1.message : String(err_1), "'"));
        ...
        this.executeRecentSearch = function (accepts) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        err_2 = _a.sent();
                        console.error("[BingFilesService.executeRecentSearch]: Err='".concat(err_2 instanceof Error ? err_2.message : String(err_2), "'"));
        ...
        this.executeBingSearch = function (queryParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        console.error("[BingFilesService.executeSearch]: Err='".concat(err_3 instanceof Error ? err_3.message : String(err_3), "'"));
        ...
        this.downloadSPFileContent = function (absoluteFileUrl, fileName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        console.error("[FileSearchService.fetchFileContent] Err='".concat(err_4 instanceof Error ? err_4.message : String(err_4), "'"));
                        return [2 /*return*/, null];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        this.downloadBingContent = function (absoluteFileUrl, fileName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        console.error("[FileSearchService.fetchFileContent] Err='".concat(err_5 instanceof Error ? err_5.message : String(err_5), "'"));
                        return [2 /*return*/, null];
                    case 4: return [2 /*return*/];
                }
            });
