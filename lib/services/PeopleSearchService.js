...
var SPPeopleSearchService = /** @class */ (function () {
    ...
    SPPeopleSearchService.prototype.generateUserPhotoLink = function (value) {
        return "".concat(this.context.pageContext.web.absoluteUrl, "/_layouts/15/userphoto.aspx?accountname=").concat(encodeURIComponent(value), "&size=M");
    };
    /**
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        userRequestUrl = "".concat(siteUrl || this.context.pageContext.web.absoluteUrl, "/_api/SP.UI.ApplicationPages.ClientPeoplePickerWebServiceInterface.clientPeoplePickerSearchUser");
                        searchBody = {
                            queryParams: {
                    ...
                    case 3:
                        ...
                        _users_2 = [];
                        batch = Web(this.context.pageContext.web.absoluteUrl).createBatch();
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, this.ensureUser(value.Key, siteUrl || this.context.pageContext.web.absoluteUrl)];
                    case 10:
                        id = _d.sent();
